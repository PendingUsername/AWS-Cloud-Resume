This is a personal website designed as a resume site. The site utilizes various technologies, including S3, AWS CloudFront, Certificate Manager, AWS Lambda, DynamoDB, GitHub Actions, Python, Java, CSS, HTML, Route 53, and AWS WAF.
